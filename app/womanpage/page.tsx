...
const NewBalanceNew = [
    {
        src: NewBalanceNewBeige.src,
        alt: 'New Balance New Beige'
    },
    {
        src: NewBalanceNewBlackAndWhite.src,
        alt: 'New Balance New Black And White'  
    },
    {
        src: NewBalanceNewWhite.src,
        alt: 'New Balance New White'
    }
]

const NikeSkate = [
    {
        src: NikeSkateAllBlack.src,
        alt: 'Nike Skate All Black'
    },
    {
        src: NikeSkateBlackAndWhite.src,
        alt: 'Nike Skate Black And White'
    },
    {
        src: NikeSkateWhite.src,
        alt: 'Nike Skate White'
    },
    {
        src: NikeSkateBlack.src,
        alt: 'Nike Skate Black'
    }
]

const PumaPalermo = [
    {
        src: PumaPalermoBlackAndWhite.src,
        alt: 'Puma Palermo Black And White'
    },
    {
        src: PumaPalermoWhite.src,  
        alt: 'Puma Palermo White'
    },
    {
        src: PumaPalermoBeige.src,
        alt: 'Puma Palermo Beige'
    },
    {
        src: PumaPalermoBrown.src,
        alt: 'Puma Palermo Brown'
    }
]

const SneakersPuma = [
    {
        src: SneakersPumaBeige.src,
        alt: 'Sneakers Puma Beige'
    },
    {
        src: SneakersPumaBlackAndWhite.src,
        alt: 'Sneakers Puma Black And White'
    },
    {
        src: SneakersPumaWhite.src,
        alt: 'Sneakers Puma White'
    }
]

const VansHylane = [
    {
        src: VansHylaneBlack.src,
        alt: 'Vans Hylane Black'
    },
    {
        src: VansHylaneBlackAndWhite.src,
        alt: 'Vans Hylane Black And White'
    },
    {
        src: VansHylaneWhite.src,
        alt: 'Vans Hylane White'
    },
    {
        src: VansHylaneWhite2.src,
        alt: 'Vans Hylane White 2'
    }
]

const AdidasSamba = [
    {
        src: AdidasSambaBlackAndWhite.src,
        alt: 'Adidas Samba Black And White'
    },
    {
        src: AdidasSambaWhite.src,
        alt: 'Adidas Samba White'
    },
    {
        src: AdidasSambaBrown.src,
        alt: 'Adidas Samba Brown'
    }
]

const NikeAirForce = [
    {
        src: NikeAirForceBeige.src,
        alt: 'Nike Air Force Beige'
    },
    {
        src: NikeAirForceBlue.src,
        alt: 'Nike Air Force Blue'
    },
    {
        src: NikeAirForcePurple.src,
        alt: 'Nike Air Force Purple'
    }
]

const VansUpland = [
    {
        src: VansUplandBeige.src,
        alt: 'Vans Upland Beige'
    },
    {   
        src: VansUplandBlackAndWhite.src,
        alt: 'Vans Upland Black And White'
    },
    {
        src: VansUplandWhite.src,
        alt: 'Vans Upland White'
    }
]
